...
virtual action * land(int &f, int &h, int &c) {
	return this;
}
...
action * landing;
virtual void zero() {
	tempLanding = NULL; landing = NULL; action::zero();
}
};
